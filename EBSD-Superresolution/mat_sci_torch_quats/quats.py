...
# Calculates orientation of pixel2, in terms of the orientation of pixel1, symmetry minimizes,
# and returns to sample frame, for subsequent fundamental zone reduction. 
def rot_dist_relative(q1, q2, syms):
        A = hadamard_prod(q1, inverse(q2))
        A_sym = outer_prod(A, syms)
